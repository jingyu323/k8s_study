...
CREATE TABLE mydatabase.test_user ( id BIGINT NOT NULL AUTO_INCREMENT,
name VARCHAR(32),
tage VARCHAR(32), 
create_time timestamp, PRIMARY KEY (id) ) ENGINE = INNODB CHARSET = utf8 DBPARTITION BY mod_hash(id) DBPARTITIONS  TBPARTITION BY mod_hash(id) TBPARTITIONS 1;
